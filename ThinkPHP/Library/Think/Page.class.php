...
class Page
{
    ...
    public function show()
    {
        ...
        $up_page = $up_row > 0 ? '<li class="paginate_button"><a href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '<li class="paginate_button disabled"><a href="">' . $this->config['prev'] . '</a></li>';

        //下一页
        $down_row  = $this->nowPage + 1;
        // $down_page = ($down_row <= $this->totalPages) ? '<a class="next" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a>' : '';
        $down_page = ($down_row <= $this->totalPages) ? '<li class="paginate_button"><a href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>' : '<li class="paginate_button disabled"><a href="">' . $this->config['next'] . '</a></li>';
        ...
        for ($i = 1; $i <= $this->rollPage; $i++) {
            ...
            if ($page > 0 && $page != $this->nowPage) {
                ...
                if ($page > 0 && 1 != $this->totalPages) {
                    ...
                    $link_page .= '<li class="paginate_button active"><a href="' . $this->url($page) . '">' . $page . '</a></li>';
                }
            }
        }
